...
class _BotCommands:
    def __init__(self):
        ...
        self.StatusCommand = [f'status2{CMD_SUFFIX}', f's2{CMD_SUFFIX}', 's', 'sall']
        ...
        self.PingCommand = [f'ping2{CMD_SUFFIX}', f'p2{CMD_SUFFIX}', 'p']
        self.RestartCommand = [f'restart2{CMD_SUFFIX}', f'r2{CMD_SUFFIX}', 'restartall', 'rall']
        self.StatsCommand = [f'stats2{CMD_SUFFIX}', f'st2{CMD_SUFFIX}', 'st', 'stall']
        ...
        self.BotSetCommand = [f'bsetting2{CMD_SUFFIX}', f'bs2{CMD_SUFFIX}', 'bs']
        ...
        self.SpeedCommand = [f'speedtest2{CMD_SUFFIX}', f'sp2{CMD_SUFFIX}', 'sp']
        ...
        self.BroadcastCommand = [f'broadcast2{CMD_SUFFIX}', f'bc2{CMD_SUFFIX}', 'bc']
